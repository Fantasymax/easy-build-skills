...
![Step 1 — 选模式 / mode selection demo](./docs/img/demo-1-mode-selection.png)
...
![A2 角色比喻 — 3+2+1 选项法 demo](./docs/img/demo-2-option-pattern.png)
...
![Step 5.5 — 6 段呈现 + 5 选项反馈 demo](./docs/img/demo-3-feedback-loop.png)
...
![Step 7.5 — AI 自测报告 demo](./docs/img/demo-4-self-validation.png)
