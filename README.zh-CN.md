...
把你某项**重复性专业工作**抽成 AI 可执行的 skill / plugin：
...
# 3. 在 Claude Code 里说一句触发
# "我想给自己定义 AI principles" 或
# "帮我把每周写日报这件事抽成一个 skill"

# 4. 跟着 AI 的选项卡答 ~15 道题，~15 分钟完成
```
...
# 然后在 Claude Code 里说："我想给自己定义 AI principles"
```

其他工具：见 [`INSTALL_TEST.md`](./INSTALL_TEST.md) Phase 1。
