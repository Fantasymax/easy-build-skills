...
![Step 1 — Mode selection demo](./docs/img/demo-1-mode-selection.svg)
...
![A2 — 3+2+1 option pattern demo](./docs/img/demo-2-option-pattern.svg)
...
![Step 5.5 — 6-segment proposal + 5-option feedback demo](./docs/img/demo-3-feedback-loop.svg)
...
![Step 7.5 — AI self-validation report demo](./docs/img/demo-4-self-validation.svg)
